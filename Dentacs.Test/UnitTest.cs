...
namespace Suconbu.Dentacs
{
    ...
    public class UnitTest
    {
        ...
        public void TestDateTimeModule()
        {
            ...
            Assert.AreEqual(module.Wareki(new[] { new Value("1868/09/08") }).String, "明治元年09月08日 戊辰");
            Assert.AreEqual(module.Wareki(new[] { new Value("1912/07/29") }).String, "明治45年07月29日 壬子");
            Assert.AreEqual(module.Wareki(new[] { new Value("1912/07/30") }).String, "大正元年07月30日 壬子");
            Assert.AreEqual(module.Wareki(new[] { new Value("1926/12/24") }).String, "大正15年12月24日 丙寅");
            Assert.AreEqual(module.Wareki(new[] { new Value("1926/12/25") }).String, "昭和元年12月25日 丙寅");
            Assert.AreEqual(module.Wareki(new[] { new Value("1989/01/07") }).String, "昭和64年01月07日 己巳 仏滅");
        ...
        public void TestTextBoxHelper()
        {
            ...
            TextBoxHelper.GetStartEndLineIndex(lines, 3, 8, out s, out e);
            Assert.AreEqual(s, 0);
            Assert.AreEqual(e, 1);
            ...
            Assert.AreEqual(s, 0);
            Assert.AreEqual(e, 0);
            TextBoxHelper.GetStartEndLineIndex(lines, 3, 4, out s, out e);
            Assert.AreEqual(s, 0);
            Assert.AreEqual(e, 0);
            TextBoxHelper.GetStartEndLineIndex(lines, 3, 5, out s, out e);
            Assert.AreEqual(s, 0);
            Assert.AreEqual(e, 0);
